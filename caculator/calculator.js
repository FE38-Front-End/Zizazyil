...
// for (let i = 0; i < evalBtn.length; i++) {
//     let result = evalBtn[i];
//     result.addEventListener('click',function (evant) {
//         eval(evant.target.textContent)  
//     })
...
var CurrentMemory = '0';//  сохранение текущего значения введенного на табло
var NewMemory = false ;//переменная обозначающая ввели мы новое число(true) или нет(false)
var ExpectedMemory = '' ;// переменная для операции в ожидании
